...
% Defines main control commands for the behaviour (lick, detection, stimuli delivery, ...)
    ...
    % Trial start: 1. if stim flag OFF, 2. no lick in quiet window 3. iti
    ...
    if perf_and_save_results_flag
        ...
        Results = [trial_number wh_stim_duration quiet_window iti association_flag is_stim is_whisker is_auditory lick_flag perf is_light reaction_time*1000 wh_stim_amp trial_start_time is_reward aud_reward wh_reward aud_stim_duration aud_stim_amp aud_stim_freq early_lick light_amp light_duration light_freq light_prestim];
        fprintf(fid1,...
...
%     queueOutputData(Stim_S,[zeros(1,Stim_S_SR/2); zeros(1,Stim_S_SR/2); zeros(1,Stim_S_SR/2)]')
        ...
        Results = [trial_number wh_stim_duration quiet_window iti association_flag is_stim is_whisker is_auditory lick_flag perf is_light reaction_time*1000 wh_stim_amp trial_start_time is_reward reward_time aud_reward wh_reward aud_stim_duration aud_stim_amp aud_stim_freq early_lick light_amp light_duration light_freq light_prestim] ;
        fprintf(fid1,...
            '%6.0f %14.1f %17.0f %11.0f %9.0f %15.0f %15.0f %12.0f %8.0f %8.0f %15.0f %15.1f %13.2f %10.0f %14.0f %10.0f %15.0f %15.0f %15.1f %15.1f %15.1f %15.1f %15.1f %15.1f %15.1f %15.1f \n',...
            Results);
