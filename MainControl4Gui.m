...
global  Stim_S Reward_S LickTime Quietwindow Trial_Duration ITI  ...
    ...
    BaselineWindow RewardShouldBeDelivered EarlylickCounter trialnumber...
...
if PerformanceAndSaveBoolian
    ...
    % Save as .txt file
    Results = [trialnumber StimDuration Quietwindow ITI Association Stim_NoStim Wh_NoWh Aud_NoAud Lick Perf Light_NoLight ReactionTime*1000 StimAmp Time Reward_NoReward Aud_Rew Wh_Rew AStimDuration AStimAmp AStimFreq EarlyLick Light_Amp Light_Duration Light_Freq Light_PreStim];
    fprintf(fid1,...
...
%     EarlyLickDetails = [trialnumber Quietwindow ITI TimeOutEarlyLick Association (toc(TrialTime)-toc(LickTime))*1000] ;
