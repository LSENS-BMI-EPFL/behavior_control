...
fprintf(fid1,'%5s %15s %15s %7s %15s %14s %16s %16s %7s %8s %15s %12s %12s %13s %13s %13s %13s %15s %15s %15s %15s %15s %15s %15s %15s \n','trialnumber',...
    'WhStimDuration','Quietwindow','ITI', 'Association',...
    'Stim/NoStim', 'Whisker/NoWhisker', 'Auditory/NoAuditory','Lick', 'Perf','Light/NoLight','ReactionTime' ,'WhStimAmp','TrialTime', 'Rew/NoRew','AudRew','WhRew','AudDur','AudDAmp','AudFreq', ...
