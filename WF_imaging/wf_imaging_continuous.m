function wf_imaging_continuous
    ...
    global WF_S Stim_S_SR handles2give trial_number Cam_vec LED1_vec LED2_vec WF_FileInfo
...
%     WF_FileInfo.file_name                  = [char(handles2give.mouse_name) '_' char(date) '_' char(time) '_trial' num2str(trial_number, '%04.0f')];
    ...
    Cam_vec = [zeros(1,2*Stim_S_SR/1000) 5*Cam_pulses(1:end-2*Stim_S_SR/1000)]; %TTL trigger pulses of 5V
    ...
    preload(WF_S, [Cam_vec; LED1_vec; LED2_vec;]')
