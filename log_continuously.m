...
continous_lick_data = continous_lick_data(end-trial_duration/1000*Log_S_SR+1:end);
...
cam1_ttl = cam1_ttl(end-trial_duration/1000*Log_S_SR+1:end);
...
cam2_ttl = cam2_ttl(end-trial_duration/1000*Log_S_SR+1:end);
...
scan_pos = scan_pos(end-trial_duration/1000*Log_S_SR+1:end);
